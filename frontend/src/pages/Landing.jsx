    ...
    return (
        <div className="landing_container">
            ...
            >
                ...
                <motion.section
                    className="landing_story_section"
                    variants={fadeUp}
                >
                    ...
                    <p>
                        ...
                        to uncover the hidden suspect, weapon, and room before anyone else does.
                    </p>
                </motion.section>

                <motion.section
                    className="landing_rules_grid"
                    variants={staggerParent}
                >
                ...
                <motion.section
                    className="landing_showcase reverse"
                    variants={fadeUp}
                >
                    <div className="landing_image_row">
